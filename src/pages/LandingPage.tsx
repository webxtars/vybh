  ...
  return (
    ...
    <div className='h-[400px] mt-16 md:mt-0 md:h-screen flex items-center justify-center'>
      ...
      <div className=' z-10 text-white text-center flex flex-col gap-4 items-center px-6'>
        <h1 className='text-3xl lg:text-6xl font-bold gradient-animation slideRightIn  bg-clip-text  text-transparent  bg-gradient-to-p from-purple to-white'>EXPERIENCE WEB-3 EVENTS</h1>
